    ...
    <body background-color="#198754">
       ...
       <section class="page-section bg-primary text-white mb-0" id="about">
        <div class="container">
            ...
            <div class="row">
                <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100"><img class="img-fluid" src="assets/img/portfolio/cabin.png" alt="..." /></div>
                <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100"><p class="lead">당신의 MBTI는 IFSP이며, 추천 음료는 캐모마일 릴렉서입니다. <br>자세한 설명은 메인 화면 내 해당 음료를 눌러주세요!</p></div>
            </div>
            <!-- About Section Button-->
            <div class="text-center mt-4">
                <a class="btn btn-xl btn-outline-light" href="/main.html">
                    메인 화면으로 돌아가기
                </a>
            </div>
        </div>
